<template>
  <div class="timeline-card" @click="$emit('click', item)">
    <div class="card-indicator" :style="{ backgroundColor: indicatorColor }"></div>

    <div class="card-body">
      <div class="card-header">
        <div class="header-left">
          <div class="type-icon" :style="typeIconStyle">
      ...
      <div class="card-footer" @click.stop="$emit('click', item)">
        ...
        <span class="footer-text">查看报告</span>
      </div>
    </div>
  </div>
</template>
...
const DEFAULT_COLOR = TIMELINE_SOURCE_COLORS.medical_check
...
const categoryColor = computed(() => {
  return props.item.extra?.category_color || DEFAULT_COLOR
})

const indicatorColor = computed(() => categoryColor.value)
...
const cardIcon = computed(() => {
  return props.item.extra?.category_icon || 'chart-trending-o'
})

const categoryLabel = computed(() => {
  return props.item.extra?.category_label || ''
})
