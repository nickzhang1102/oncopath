...
| 📁 报告散落在微信、纸质袋、各家医院系统里 | 检验 / 检查 / 病理 / 用药 / 时间线事件**五源聚合成一条治疗时间线**，可追溯、可筛选、可导出 PDF |
| 📉 关键指标的变化趋势只能靠手抄对比 | 异常指标自动追踪，任意指标**趋势图表 + 组合横向对比** |
| 🏥 见医生前想不好该问什么 | 一键聚合病历资料生成会诊提示词，通过 **AgentTeams 集成发起多智能体虚拟会诊** |

OncoPath 面向患者家属和家庭自部署场景：数据存在你自己的服务器上，敏感字段全程加密，AI 只做信息整理与辅助理解——最终判断永远属于你和医生。
...
| 🛡️ **仪表盘** | 当前用药 / 异常指标 / 待审 OCR / 进行中会诊一站式总览 |
